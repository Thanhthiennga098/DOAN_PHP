                    ...
                    <div class="col-xs-12">
                        <div class="bradcaump__inner">
                            <nav class="bradcaump-inner">
                                ...
                                <span class="breadcrumb-item active">Theo Phẩm Theo Danh Mục</span>
                            </nav>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="htc__product__rightidebar">
                        ...
                        <div class="row">
                            <div class="shop__grid__view__wrap">
                                ...
                                <?php
                                    $ShowDanhMuc = $SanPham->ShowDanhMuc($IDTheLoai);
                                    if($ShowDanhMuc){
                                        while($RowDanhMucSP = $ShowDanhMuc->fetch_assoc()){
                                    ?>
                                    <!-- Start Single Product -->
                                    <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                                        <div class="category">
                                            <div class="ht__cat__thumb">
                                                <a href="chi-tiet-san-pham/<?=$RowDanhMucSP['IDSanPham']?>/<?=makeUrl($RowDanhMucSP['TenSanPham'])?>.html">
                                                    <img src="images/products/<?=$RowDanhMucSP['AnhDaiDien']?>" alt="product images">
                                                </a>
                                            </div>
                                                    ...
                                                    <li>
                                                        <form action="" method="post">
                                                            <div class="input-group">
                                                                <input type="hidden" value="<?=$RowDanhMucSP['IDSanPham']?>" name="IDSanPham">
                                                        ...
                                                        <li>
                                                            <form action="" method="post">
                                                                <div class="input-group">
                                                                    ...
                                                                    <button type="submit" name="ThemVaoGioHang" style="border:none;">
                                            ...
                                            <div class="fr__product__inner">
                                                <h4><a href="chi-tiet-san-pham/<?=$RowDanhMucSP['IDSanPham']?>/<?=makeUrl($RowDanhMucSP['TenSanPham'])?>.html"><?=$RowDanhMucSP['TenSanPham']?></a></h4>
                                                <ul class="fr__pro__prize">
                                                    <?php
                                                        if($RowDanhMucSP['GiaKhuyenMai'] == 0){
                                                        ?>
                                                        <li> <span><?=number_format($RowDanhMucSP['GiaBan'])?></span> <sup>đ</sup></li>
                                                        <?php
                                                        }else{
                                                            ?>
                                                                <li><del><?=number_format($RowDanhMucSP['GiaBan'])?></del> <sup>đ</sup></li>
                                                                <li><?=number_format($RowDanhMucSP['GiaKhuyenMai'])?> <sup>đ</sup></li>
                                                            <?php
                                                        }
                                                    ?>
                                                </ul>
                                        ...
                                        <?php
                                            ...
                                            <div class="ht__list__product">
                                                <div class="ht__list__thumb">
                                                    <a href="chi-tiet-san-pham/<?=$RowDanhMucSP['IDSanPham']?>/<?=makeUrl($RowDanhMucSP['TenSanPham'])?>.html"><img src="images/products/<?=$RowDanhMucSP['AnhDaiDien']?>"></a>
                                                </div>
                                                <div class="htc__list__details">
                                                    <h2><a href="chi-tiet-san-pham/<?=$RowDanhMucSP['IDSanPham']?>/<?=makeUrl($RowDanhMucSP['TenSanPham'])?>.html"><?=$RowDanhMucSP['TenSanPham']?></a></h2>
                                                    <ul  class="pro__prize">
                                                    <?php
                                                        if($RowDanhMucSP['GiaKhuyenMai'] == 0){
                                                        ?>
                                                        ...
                                                        <?php
                                                            ...
                                                            ?>
                                                                <li><del><?=number_format($RowDanhMucSP['GiaBan'])?></del> <sup>đ</sup></li> &ensp;
                                                                <li><?=number_format($RowDanhMucSP['GiaKhuyenMai'])?> <sup>đ</sup></li>
                                                            <?php
                                                        }
                                                    ?>
                                                    ...
                                                    <p>Nhóm Hương : <?=$RowDanhMucSP['NhomHuong']?></p>
                                                    ...
                                                    <?php
                                                        ...
                                                        <?php
                                                            ...
                                                            ?>
                                                                <a href="tai-khoan.html" class="btn btn-danger" style="background-color: #c43b68;">Thêm vào giỏ hàng</a>
                                                            <?php
                                                        }
                                                    ?>     
                                                    </div>
